...
<template>
    <div class="flex items-center gap-2">
        ...
        <button
            ...
            class="flex items-center justify-center w-9 h-9 rounded-lg bg-white/5 hover:bg-[#30998A]/15 text-white/50 hover:text-[#30998A] transition-all duration-200 cursor-pointer focus-ring border-0"
        >
            <Check v-if="copied" class="w-4 h-4 text-[#30998A]" />
